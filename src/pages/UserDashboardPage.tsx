...
import { FiMap, FiClipboard, FiBarChart2, FiSearch } from 'react-icons/fi';
...
const UserDashboardPage: React.FC = () => {
  ...
  const quickActions = [
    { name: 'View Public Map', href: '/map', icon: <IconWrapper><FiMap className="w-8 h-8 text-blue-500" /></IconWrapper> },
    { name: 'Browse Claims', href: '/claims', icon: <IconWrapper><FiClipboard className="w-8 h-8 text-green-500" /></IconWrapper> },
    { name: 'View Reports', href: '/reports', icon: <IconWrapper><FiBarChart2 className="w-8 h-8 text-indigo-500" /></IconWrapper> },
    { name: 'Search Assets', href: '/asset-mapping', icon: <IconWrapper><FiSearch className="w-8 h-8 text-purple-500" /></IconWrapper> },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        {/* Information Section */}
        <div className="px-4 py-6 sm:px-0">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">About FRA Atlas</h2>
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <div className="prose max-w-none">
                <p className="text-gray-600">
                  The FRA Atlas & WebGIS DSS is a comprehensive platform for managing and visualizing Forest Rights Act claims. 
                  As a normal user, you can browse public information about forest claims, view reports, and explore the map data.
                </p>
                <p className="mt-4 text-gray-600">
                  For more information or to submit a claim, please contact your local field officer or visit the nearest forest department office.
                </p>
              </div>
            </div>
          </div>
